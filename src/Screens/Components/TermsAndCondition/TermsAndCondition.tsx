...
const TermsAndConditions = () => {
  return (
    <div className="bg-[#fefefe] max-w-3xl mx-auto my-6 p-6 border border-gray-400 shadow-md rounded-md font-serif text-[15px] text-gray-900 leading-relaxed">
      <h1 className="text-center text-xl font-bold uppercase mb-4 border-b border-gray-300 pb-2">
      ...
      <div className="space-y-4">
        ...
        <h2 className="text-center text-lg font-bold uppercase mt-8 mb-2 border-b border-gray-300 pb-1">
