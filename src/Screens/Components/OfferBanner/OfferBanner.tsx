...
const OfferBanner = () => {
  return (
    ...
    >
      <div className="bg-pink-400 w-full h-[120px] sm:h-[200px] flex items-center justify-center px-4 cursor-pointer">
        <div className="text-center flex flex-col items-center gap-2 sm:gap-4">
          ...
          <div className="text-3xl sm:text-5xl font-extrabold text-transparent bg-clip-text bg-gradient-to-r from-yellow-300 via-yellow-400 to-yellow-500">
