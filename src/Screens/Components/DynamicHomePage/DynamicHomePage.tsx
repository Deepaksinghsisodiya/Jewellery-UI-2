...
const DynamicHomePage = () => {
  ...
  useEffect(() => {
    ...
    setSelectedCategory(currentCategory?.name?.toLowerCase() || "");
  }, [catId]);
  ...
  return (
    <>
      ...
      <div>
        ...
        <div className="w-[90%] mx-auto mb-4">
          <Carousel media={category?.media?.carousel} />
        </div>

        <ImagesComponent media={category?.media?.imagesComponent} />
        <MiddleImageComponent media={category?.media?.middleImageComponent} />

        <div className="w-[90%] mx-auto">
          <SmallImgCarosel media={category?.media?.smallImgCarousel} />
          <VideoComponent
            key={category?.id}
            media={category?.media?.videoComponent}
            content={category?.media?.content}
          />
        </div>
        ...
        <DiscoverComponent
          title="DISCOVER"
          subtitle="GK JEWELERS"
          media={category?.media?.discoverImg}
        />
        ...
        <RecentImg media={category?.media?.recentImg} />
